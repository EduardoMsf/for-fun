...
export type ProductWhereInput = {
  ...
  size?: Prisma.EnumSizeNullableListFilter<"Product">
...
export type ProductCreateInput = {
  ...
  inStock: number
  price?: number
  size?: Prisma.ProductCreatesizeInput | $Enums.Size[]
  slug: string
...
export type ProductUpdateInput = {
  ...
  size?: Prisma.ProductUpdatesizeInput | $Enums.Size[]
...
export type ProductOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"description" | "id" | "inStock" | "price" | "size" | "slug" | "tags" | "title" | "gender" | "categoryId", ExtArgs["result"]["product"]>
...
export interface ProductDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productWithDescriptionOnly = await prisma.product.findMany({ select: { description: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Products and only return the `description`
   * const productWithDescriptionOnly = await prisma.product.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Products and only return the `description`
   * const productWithDescriptionOnly = await prisma.product.updateManyAndReturn({
   *   select: { description: true },
   *   where: {
   *     // ... provide filter here
   *   },
